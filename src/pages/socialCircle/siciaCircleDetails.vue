		...
		<view class="head-title">
			...
			<view class="share-content">
				...
				<view class="content-right">
					...
					<view class="grids">
						<view class="grids-item" v-for="image in obj.images">
			...
			<!-- 评论区 -->
			<view class="comments">
				<view style="width: 100%;height: 40px;font-size: 16px;padding-left: 15px;">评论</view>
...
<script>
	...
	export default{
		...
		data(){
			return{
				obj:{avatar:'https://fuss10.elemecdn.com/9/bb/e27858e973f5d7d3904835f46abbdjpeg.jpeg',
