<template>
	<view class="content">
		...
		<view class="timer">
			...
			@timeup="timerUp"></uni-countdown></view>
	...
	export default {
		...
		data() {
			return {
				...
				// 中部分类
				buttonImagesOne:[{img:'../../static/testImages/q.jpg',title:'会员专享'},
				{img:'../../static/testImages/w.jpg',title:'有机专区'},
				{img:'../../static/testImages/e.jpg',title:'厨房用具'},
				{img:'../../static/testImages/r.jpg',title:'生活电器'},
				{img:'../../static/testImages/t.jpg',title:'食品粮油'}],
				buttonImageTwo:[{img:'../../static/testImages/y.jpg',title:'居家用品'},
				{img:'../../static/testImages/u.jpg',title:'限时秒杀'},
				{img:'../../static/testImages/i.jpg',title:'一元抢购'},
				{img:'../../static/testImages/o.jpg',title:'9.9拼团'},
				{img:'../../static/testImages/p.jpg',title:'积分兑换'}],
